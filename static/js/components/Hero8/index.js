...
const Hero8 = (props) => {
    return ( <
        ...
        data - wow - delay = "0.5s" > I Take Care Of Your Healthy Health < /h2> <
        span className = "wow fadeInUp"
        data - wow - delay = "0.8s" > Many of the normal daily activities we take
        for granted.Dpend on the health of our Eyes. < /span> <
