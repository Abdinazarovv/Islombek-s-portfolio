...
const Hero2 = (props) => {
    return ( <
        ...
        data - wow - delay = "0.5s" > We are Southern - European Digital Agency < /h2> <
        span className = "wow fadeInUp"
        data - wow - delay = "0.8s" > More than 10 years of creating digital solutions < /span> <
        div className = "wow fadeInUp"
        data - wow - delay = "1.0s" >
        <
        Link to = "/about"
        className = "theme-btn" > More About < /Link> <
        Link to = "/contact"
        className = "theme-btn-s2" > Contact Us < /Link> <
        /div> <
        /div> <
        /div> <
        /div> <
