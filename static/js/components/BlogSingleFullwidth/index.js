...
const BlogSingleFullwidth = () => {
    ...
    return ( <
        ...
        <
        li > < Link to = "/blog-details" > < img src = {
            blog6
        }
        alt = "" / > By Admin < /Link></li >
        <
        ...
        <
        Link to = "/blog-details"
        className = "author-name" > Henry Joyes < /Link> <
        ...
        <
        h4 > John Abraham < span className = "comments-date" > Octobor 28, 2018 At 9.00 am < /span></h
        4 >
        <
        /div> <
        ...
        to = "/blog-details" > < i className = "fa fa-reply"
        ...
        div className = "comments-meta" >
        <
        h4 > Lily Watson < span className = "comments-date" > Octobor 28, 2018 At 9.00 am < /span></h
        4 >
        <
        /div> <
        div className = "comment-area" >
        ...
        <
        Link className = "comment-reply-link"
        to = "/blog-details" > < span > < i className = "fa fa-reply"
        aria - hidden = "true" > < /i> Reply</span > < /Link> <
        /div> <
        /div> <
        /div> <
        /div> <
