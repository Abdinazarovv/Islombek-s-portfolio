...
const ServiceSingle = (props) => {
    return ( <
        ...
        <
        li > < Link to = "/serviceDetails" > 3 D Design < /Link></li >
        <
        ...
        t anything embarrassing hidden in the middle of text.All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. < /p> <
