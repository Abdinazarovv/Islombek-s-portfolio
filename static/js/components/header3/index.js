...
const Header3 = (props) => {
    return ( <
        div className = {
            `header-style-1 ${props.headerclass}`
        } >
        <
        ...
        title = "" > Blog < /Link></li >
        <
        li > < Link to = "/blogfullwidth"
        title = "" > Blog Fullwidth < /Link></li >
        <
        li > < Link to = "/"
        title = "" > Blog Details < /Link> <
        ul >
        <
        li > < Link to = "/blog-details"
        title = "" > Blog Details < /Link></li >
        <
        li > < Link to = "/blog-details-fullwidth"
        title = "" > Blog Details Fullwidth < /Link></li >
        <
        /ul> <
        /li> <
        /ul> <
        ...
        <
        Link to = "/contact"
        className = "theme-btn-s2" > Lets Talk < /Link> <
        /div> <
        /div> <
