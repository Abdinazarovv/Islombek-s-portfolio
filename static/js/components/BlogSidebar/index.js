...
const BlogSidebar = () => {
    ...
    return ( <
        ...
        <
        h4 > < Link to = "/blog-details" > 6 Ideas
        for how you can avoid telling lie < /Link></h
        4 >
        <
        ...
        div className = "details" >
        <
        h4 > < Link to = "/blog-details" > The definitive list of digital products you can sell < /Link></h
        4 >
        <
        span className = "date" > 22 Sep 2020 < /span> <
        /div> <
