...
class Portfolio2 extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            li > < Link data - filter = ".Web-Design"
            to = "/"
            onClick = {
                webDesign
            } > Web Design < /Link></li >
            <
            li > < Link data - filter = ".Print-Design"
            to = "/"
            onClick = {
                printDesign
            } > Print Design < /Link></li >
            <
            li > < Link data - filter = ".Web-Application"
            to = "/"
            onClick = {
                webApp
            } > Web Application < /Link></li >
            <
            li > < Link data - filter = ".Photography"
            to = "/"
            onClick = {
                Photography
            } > Photography < /Link></li >
            ...
            <
            Link to = "/protfolioGrid2"
            className = "theme-btn-s2" > Load More < /Link> <
            /div> <
            /div> <
            /div> <
            /div> <
