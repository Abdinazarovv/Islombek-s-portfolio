...
const HomePage4 = () => {
    return ( <
        ...
        MySkill / >
        <
        ServiceSection serviceclass = {
            'wpo-service-area-4 section-padding'
        }
        /> <
        PorfolioSection2 protfclass = {
            'wpo-protfolio-area-4'
        }
        /> <
        TestSlider2 testclass = {
            'wpo-testimonial-area-4'
        }
        /> <
        ContactArea contactclass = {
            'wpo-contact-area4'
        }
        /> <
        PartnerSlider partnerclass = {
            'wpo-client-area2'
        }
        /> <
        Footer Ftclass = {
